...
mod test {
    ...
    fn test_field_comparison_metadata() {
        let f1 = Field::new("x", DataType::Binary, false).with_metadata(indexmap! {
            "k1".to_string() => "v1".to_string(),
            "k2".to_string() => "v2".to_string(),
        });
        let f2 = Field::new("x", DataType::Binary, false).with_metadata(indexmap! {
            "k1".to_string() => "v1".to_string(),
            "k3".to_string() => "v3".to_string(),
        });
        let f3 = Field::new("x", DataType::Binary, false).with_metadata(indexmap! {
            "k1".to_string() => "v1".to_string(),
    ...
    fn test_field_with_empty_metadata_serde() {
        let field = Field::new("name", DataType::Boolean, false).with_metadata(IndexMap::default());
